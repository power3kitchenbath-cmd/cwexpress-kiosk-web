...
DO $$ 
BEGIN
    DROP POLICY IF EXISTS "Admins can view warmup schedules" ON public.email_warmup_schedule;
    DROP POLICY IF EXISTS "Admins can insert warmup schedules" ON public.email_warmup_schedule;
    DROP POLICY IF EXISTS "Admins can update warmup schedules" ON public.email_warmup_schedule;
    DROP POLICY IF EXISTS "Admins can delete warmup schedules" ON public.email_warmup_schedule;
    DROP POLICY IF EXISTS "Admins can view warmup daily stats" ON public.email_warmup_daily_stats;
    DROP POLICY IF EXISTS "Service role can insert warmup daily stats" ON public.email_warmup_daily_stats;
    DROP POLICY IF EXISTS "Service role can update warmup daily stats" ON public.email_warmup_daily_stats;
EXCEPTION
...
-- Recreate policies for email_warmup_schedule
...
-- Recreate policies for email_warmup_daily_stats
...
DROP TRIGGER IF EXISTS update_email_warmup_schedule_updated_at ON public.email_warmup_schedule;
